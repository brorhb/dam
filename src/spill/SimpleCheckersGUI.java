 ...
 * spill.SimpleCheckersGUI.java (see Javadoc comment for details)
 */
...
/** Creates a new instance of spill.Board and draws a necessary graphical interface
...
public class SimpleCheckersGUI implements MouseListener, ActionListener, Serializable {

    /** The frame that will serve to holds the contents of our game */
    private JFrame frame;

    /** The panel that will hold our spill.Board */
    ...
    /** Hold a reference to the currently selected spill.Piece */
    ...
    public void CreateAndShowGUI() {
        ...
        frame = new JFrame("spill.SimpleCheckersGUI - Matthew Proetsch");
        ...
        //Give our spill.Board a visual representation
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        //Ensure that the correct color spill.Piece has been chosen
        //The spill.Piece's color should be equal to currentTurn, unless this is the first move
		 ...
		 * only four scenarios:
		 * 1) The user has nothing highlighted and wishes to highlight a new spill.Square
		 * 2) The user wishes to change the spill.Square that is selected
		 * 3) The user wishes to deselect the current spill.Square
        ...
        if(sel.isOccupied() && selectedSquare == null) {
            ...
            //The user has clicked on a different spill.Piece than the one currently selected
        ...
        //Move-checking code
            ...
            if(found) {
                ...
                //Unhighlight the moves from the spill.Piece's previous position
                selectedSquare.setHighlight(false);
    ...
    /** Add the spill.Board to a Panel to create the appearance of a checkerboard
     *
     * @param b						The spill.Board to add to a JPanel
